...
from zoo.robosuite.env.robosuite_wrappers import wrap_lightzero


@ENV_REGISTRY.register('robosuite_lightzero')
class RobosuiteEnvLightZero(BaseEnv):
    ...
    def __repr__(self) -> str:
        ...
        """
        return "LightZero Robosuite Env Lift"
