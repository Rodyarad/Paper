...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate a DINOSAUR-based policy on Robosuite.")
    parser.add_argument("--seeds", type=int, nargs="+", default=[777])
    parser.add_argument("--episodes-per-seed", type=int, default=1)
    parser.add_argument("--eval-max-steps", type=int, default=125)
...
if __name__ == "__main__":
    ...
    for seed in args.seeds:
        returns_mean, returns = eval_muzero(
            ...
            model_path='/home/rodya-rad/Desktop/work/LightZero/oc_agents_weights/oz_stica_robosuite_seed7.tar',
        )
