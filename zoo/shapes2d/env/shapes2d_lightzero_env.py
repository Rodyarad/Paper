...
from zoo.shapes2d.env.shapes2d_wrappers import wrap_lightzero

@ENV_REGISTRY.register('shapes2d_lightzero')
class Shapes2dEnvLightZero(BaseEnv):
    """
    Overview:
    ...
    def __repr__(self) -> str:
        return "LightZero Shapes2d Env({})".format(self.cfg.env_id)
