...
shapes2d_efficientzero_config = EasyDict(shapes2d_efficientzero_config)
main_config = shapes2d_efficientzero_config

shapes2d_efficientzero_create_config = dict(
    env=dict(
...
shapes2d_efficientzero_create_config = EasyDict(shapes2d_efficientzero_create_config)
create_config = shapes2d_efficientzero_create_config
